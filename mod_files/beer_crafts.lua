...
-- These Tankards are new

 minetest.register_craft({
	output = "beer_test:tankard",
	recipe = {
		{"default:wood","default:wood", "moreores:tin_ingot"},
 ...
 minetest.register_craft({
	output = "beer_test:tankard",
	recipe = {
		{"default:wood","default:wood", "default:glass"},
		{"default:glass","", "default:glass"},
		{"default:glass","default:glass", "default:glass"},
	}	
})

-- finished new Tankards
...
-- temp crafts --
 ...
 minetest.register_craft({
	output = "beer_test:barrel_mixed_mead_grain",
	type = "shapeless",
